...
test_in_bettwen_powert = TTestData('Power throttled bettwen checks', TTestFSState([1, 2, 1, 0], [1, 0, 1, 0]), 'OK',
                                  [('warning', 'CPU was power throttled')])
test_in_bettwen_thermalt = TTestData('Power throttled bettwen checks', TTestFSState([1, 0, 1, 2], [1, 0, 1, 0]), 'OK',
                                  [('warning', 'CPU was thermal throttled')])
test_no_sensors = TTestData('No sensors', TTestFSState([], []), 'OK',
                                   [('error', 'Failed to check CPU thottling: Could not read the')])
...
test_ddr_no_sensors = TTestData('DDR no sensor', TTestFSState([], []), 'OK',
                                   [('error', 'Failed to check DDR thottling: Could not read the')])

all_cpu_tests = [test_first_run_ok,
                 test_first_run_powert,
                 test_recovered_powert,
                 test_recovered_thermalt,
                 test_in_bettwen_powert,
                 test_in_bettwen_thermalt,
                 test_no_sensors]
