...
$(SONIC_BF2_IMAGE_BASE)_INSTALLS += $(SYSTEMD_SONIC_GENERATOR) \
                                    $(LIBPKA_DEB) \
                                    $(KERNEL_MFT) \
                                    $(MFT_OEM) \
                                    $(MFT) \
...
$(SONIC_BF2_IMAGE_PXE)_FILES += $($(SONIC_BF2_IMAGE_BASE)_FILES) $(MLX_BOOTCTL_DRIVER)

# The traditional *.bin image. Works for sonic-sonic upgrade.
SONIC_BF2_IMAGE_BIN = $(SONIC_BF2_IMAGE_BASE).bin
$(SONIC_BF2_IMAGE_BIN)_IMAGE_TYPE = bin # sonic-sonic only
...
$(SONIC_BF2_IMAGE_BIN)_FILES += $($(SONIC_BF2_IMAGE_BASE)_FILES)
...
$(SONIC_BF2_IMAGE_BFB)_FILES += $($(SONIC_BF2_IMAGE_BASE)_FILES) $(MLX_BOOTCTL_DRIVER)
