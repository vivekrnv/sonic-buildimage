...
BF2_PLATFORM_DRIVERS += $(MLXBF3_PINCTRL_DRIVER)
...
SONIC_MAKE_FILES += $(BF2_PLATFORM_DRIVERS)
SONIC_MAKE_DEBS += $(BFSOC_MAKE_DEBS)
SONIC_ONLINE_DEBS += $(BFSOC_ONLINE_DEBS)
else
$(eval $(foreach file,$(BF2_PLATFORM_DRIVERS) $(BFSOC_MAKE_DEBS) $(BFSOC_MAKE_DEBS_DERIVED) $(BFSOC_ONLINE_DEBS), $(call make_url_bfsoc,$(file))))
SONIC_ONLINE_FILES += $(BF2_PLATFORM_DRIVERS)
