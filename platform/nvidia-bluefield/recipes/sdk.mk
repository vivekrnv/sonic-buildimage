...
SDN_APPL_DBGSYM = sdn-appliance-dbgsym_$(SDN_APPL_VER)_$(CONFIGURED_ARCH).deb
$(eval $(call add_derived_package,$(SDN_APPL),$(SDN_APPL_DBGSYM)))

SDN_APPL_DERIVED_DEBS = $(SDN_APPL_DBGSYM)
export SDN_APPL_DERIVED_DEBS
export SDN_APPL_DBGSYM
