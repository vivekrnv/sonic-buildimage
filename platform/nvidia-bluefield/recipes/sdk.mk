...
ifeq ($(SDK_FROM_SRC), y)
SONIC_MAKE_DEBS += $(OFED_KERNEL) $(UCX) $(RXPCOMPILER) $(RDMA_CORE) $(DPDK) $(LIBGRPC_DEV) $(DOCA_LIBS) $(SDN_APPL)
else
SONIC_COPY_DEBS += $(OFED_KERNEL) $(UCX) $(RXPCOMPILER) $(RDMA_CORE) $(DPDK) $(LIBGRPC_DEV) $(DOCA_LIBS) $(SDN_APPL)
endif

sdk-packages: $(addprefix $(DEBS_PATH)/, $(OFED_KERNEL) $(UCX) $(RXPCOMPILER) $(COLLECTX_CLXAPI) $(RDMA_CORE) $(DPDK) $(LIBGRPC_DEV) $(DOCA_LIBS) $(SDN_APPL))
