...
$(DOCKER_SYNCD_BASE)_DEPENDS += $(SYNCD) $(MFT) $(SDN_APPL) $(SDN_APPL_DBGSYM) $(DPU_SAI) $(DPU_SAI_DBGSYM) $(MLNX_IPROUTE2) $(SYNCD_DBG) $(LIBSAIREDIS_DBG) $(LIBSAIREDIS_DBG)
...
ifeq ($(SDK_FROM_SRC), y)
$(DOCKER_SYNCD_BASE)_DBG_DEPENDS += $(DPU_SAI_DBGSYM) $(SDN_APPL_DBGSYM)
endif
