...
HWMGMT_MODULES = hwmgmt-modules-$(KVERSION)_$(MLNX_HW_MANAGEMENT_VERSION)_$(CONFIGURED_ARCH).deb
$(HWMGMT_MODULES)_SRC_PATH = $(PLATFORM_PATH)/hw-management
$(HWMGMT_MODULES)_DEPENDS += $(LINUX_HEADERS) $(LINUX_HEADERS_COMMON)
SONIC_MAKE_DEBS += $(HWMGMT_MODULES)
