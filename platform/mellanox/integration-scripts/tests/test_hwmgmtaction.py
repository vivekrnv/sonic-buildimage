...
def mock_hwmgmt_args():
    with mock.patch("sys.argv", ["hwmgmt_kernel_patches.py", "post",
                                "--patches", "/tmp",
                                "--non_up_patches", "/tmp",
                                "--config_inc", MOCK_KCFG_DIR+"/new_kconfig",
                                "--config_inc_arm", MOCK_KCFG_DIR+"/new_kconfig_arm",
                                "--config_base", MOCK_KCFG_DIR+"/x86.config",
                                "--config_base_arm", MOCK_KCFG_DIR+"/arm64.config",
                                "--config_inc_down", MOCK_KCFG_DIR+"/new_kconfig_down",
                                "--config_inc_down_arm", MOCK_KCFG_DIR+"/new_kconfig_down_arm",
